...
def edit(id):
    ...
    if request.method=="POST":
        ...
        query=db.engine.execute(f"UPDATE `student` SET `sname`='{sname}',`sem`='{sem}',`gender`='{gender}',`branch`='{branch}',`email`='{email}',`number`='{num}',`address`='{address}' WHERE `rollno`='{rollno}'")
